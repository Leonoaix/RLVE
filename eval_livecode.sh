...
EVAL_SCRIPT="scripts/evaluation/DeepSeek-R1-Distill-Qwen-1.5B/eval_LiveCodeBench.sh"
LOG_FILE="eval_time_livecode.txt"
...
run_eval "../models/DeepSeek-R1-Distill-Qwen-1.5B"
